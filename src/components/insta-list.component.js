...
import InstaTableRow from './InstaTableRow';// need to change 
...
export default class InstaList extends Component {
  ...
  render() {
    return (<div className="table-wrapper">
      ...
      <button className="btn btn-success"><a href="/create-insta" style={{textDecoration:'none',color:'white'}}><i class="fas fa-graduation-cap"></i>&nbsp;Add instuctor Details</a></button>
      &nbsp;&nbsp;
<button className="btn btn-success"><a href="/instaPDF" style={{textDecoration:'none',color:'white'}}> <i class="fas fa-book"></i>&nbsp;Genarate Report</a></button>
    </div>);
  }
}