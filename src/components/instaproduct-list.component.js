...
import InstaTableRowProduct from './InstaTableRowProduct'// need to change
import "./pro.css"; 
...
export default class InstaList extends Component {
  ...
  DataTable() {
    return this.state.returns.map((res, i) => {
      return <InstaTableRowProduct obj={res} key={i} />;
    });
  }
  ...
  render() {
    return (<div className="table-wrapper">
      ...
      <br></br>
      <br></br>
      <h2><i class="fas fa-graduation-cap"></i>&nbsp;Instuctor Details List</h2><br/>
